...
| ------------- | ------------- | ------------- |
| [**createCreditSession()**](SessionsApi.md#createCreditSession) | **POST** /payments/v1/sessions | Create a session |
| [**readCreditSession()**](SessionsApi.md#readCreditSession) | **GET** /payments/v1/sessions/{session_id} | Get details about a session |
| [**updateCreditSession()**](SessionsApi.md#updateCreditSession) | **POST** /payments/v1/sessions/{session_id} | Update a session |
