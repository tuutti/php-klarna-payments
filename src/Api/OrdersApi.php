...
use Klarna\Payments\FormDataProcessor;
...
class OrdersApi
{
     ...
     *
     * @param  string $authorization_token authorization_token (required)
     * @param  \Klarna\Payments\Model\CreateOrderRequest|null $create_order_request create_order_request (optional)
     ...
     *
     * @param  string $authorization_token (required)
     * @param  \Klarna\Payments\Model\CreateOrderRequest|null $create_order_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createOrder'] to see the possible values for this operation
     *
     * @throws \Klarna\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $authorization_token authorization_token (required)
     * @param  \Klarna\Payments\Model\CustomerTokenCreationRequest|null $customer_token_creation_request customer_token_creation_request (optional)
     ...
     *
     * @param  string $authorization_token (required)
     * @param  \Klarna\Payments\Model\CustomerTokenCreationRequest|null $customer_token_creation_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['purchaseToken'] to see the possible values for this operation
     *
     * @throws \Klarna\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
