...
class SessionsApi
{
     ...
     */
    public function createCreditSessionRequest($body)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function readCreditSessionRequest($session_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateCreditSessionRequest($session_id, $body)
    {
        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
