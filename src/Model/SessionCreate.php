...
class SessionCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('step_up_id', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getStepUpId()
    {
        return $this->container['step_up_id'];
    }

    /**
     * Sets step_up_id
     *
     * @param string|null $step_up_id Step-up recovery identifier obtained from a failed token charge. Use this ID to create a recovery session for customer flow.
     *
     * @return self
     */
    public function setStepUpId($step_up_id)
    {
        if (is_null($step_up_id)) {
            throw new \InvalidArgumentException('non-nullable step_up_id cannot be null');
        }
        $this->container['step_up_id'] = $step_up_id;
