...
class Address implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCountry($country)
    {
        ...
        if ((!preg_match("/^[A-Za-z]{2,2}$/", ObjectSerializer::toString($country)))) {
     ...
     * Sets postal_code
     *
     * @param string|null $postal_code Customer’s postal code. Validation according to [Universal Postal Union addressing system](https://www.upu.int/en/activities/addressing/postal-addressing-systems-in-member-countries.html). E.g. 12345, W1G OPW.
     *
     * @return self
     */
     ...
     * Sets region
     *
     * @param string|null $region Customer’s region or state - Mandatory for US and AU market. Validations according to ISO 3166-2 format, e.g. US-OH, AU-ACT, etc.
     *
     * @return self
     */
     ...
     * Sets street_address
     *
     * @param string|null $street_address Customer’s street address. Validation according to [Universal Postal Union addressing system](https://www.upu.int/en/activities/addressing/postal-addressing-systems-in-member-countries.html). Regional formatting is required, as follows: UK/US/FR: 33 Cavendish Square Rest of EU: De Ruijterkade 7
     *
     * @return self
     */
