...
class Customer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets customer_token
     *
     * @param string|null $customer_token Klarna Customer Token. This token can be used to identify a returning customer and provide a faster checkout experience.
     *
     * @return self
     */
    ...
    public function setLastFourSsn($last_four_ssn)
    {
        ...
        if ((!preg_match("/^([0-9]{4}|[0-9]{9})$/", ObjectSerializer::toString($last_four_ssn)))) {
    ...
    public function setType($type)
    {
        ...
        if ((!preg_match("/^(person|organization)$/", ObjectSerializer::toString($type)))) {
