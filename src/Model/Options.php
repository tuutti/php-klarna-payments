...
class Options implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['color_border'] = $data['color_border'] ?? null;
        $this->container['color_border_selected'] = $data['color_border_selected'] ?? null;
        $this->container['color_details'] = $data['color_details'] ?? null;
        $this->container['color_text'] = $data['color_text'] ?? null;
