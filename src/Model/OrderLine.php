...
class OrderLine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets total_amount
     *
     * @param int $total_amount Total amount of the order line. Must be defined as minor units. Includes tax and discount. Eg: 2000=20 euros Value = (quantity x unit_price) - total_discount_amount.  (max value: 200000000)
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type Type of the order line item.
     *
     * @return self
     */
